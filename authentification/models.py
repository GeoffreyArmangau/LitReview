...
# création de modèles personnalisés pour les utilisateurs avec des rôles et des relations de suivi
class CustomUser(AbstractUser):
	"""
	Modèle utilisateur personnalisé avec des rôles et des relations de suivi.
	Attributs :
		- role : champ de choix pour différencier les rôles d'utilisateur (USER ou DEVELOPER)
		- is_developer : champ booléen indiquant si l'utilisateur est un développeur
	Méthodes :
		- save : surcharge de la méthode de sauvegarde pour gérer les groupes d'utilisateurs en fonction du rôle
	"""
	ROLE_USER = 'USER'
